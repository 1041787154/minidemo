...
public class AjaxService extends BaseService {
	...
	public void SearchEmployees() throws Exception
	{
	    ...
	    HashMap result = new AppService().searchEmployeesResult(key, pageIndex, pageSize, sortField, sortOrder);	    
	    renderJson(result);
	}
	...
	{
	    String id = getString("id");
	    HashMap o = new AppService().getEmployee(id); 
	    renderJson(o);
	}
	...
	public void GetDepartmentEmployees() throws Exception
	{
	    ...
	    HashMap result = new AppService().getEmployeesByDeptIdResult(dept_id, pageIndex, pageSize);
	    renderJson(result);
	}
...
//	}
	...
	{ 		
	    ...
	    HashMap result = new AppService().searchEmployeesResult(key, pageIndex, pageSize, sortFields);
